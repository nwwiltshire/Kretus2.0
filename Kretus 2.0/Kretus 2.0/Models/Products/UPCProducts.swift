...
extension UPCCoat {
    func findProducts() {
        ...
        switch self.subType {
            ...
            self.partA = Product(id: "EX-KUPCARC-EA",
                                 name: "UPC Part A: RC/TT, 6 lbs")
            self.partC = Product(id: "EX-KUPCRFC-EA",
                                 name: "UPC Part C: RC, 6 lbs")
            
            switch self.speed {
                
                case .ez:
                
                self.partB = Product(id: "EX-KUPCRCZ6-EA",
                                     name: "UPC Part B: RC/TT - EZ, 6 lbs")
                
                case .ap:
                
                self.partB = Product(id: "EX-KUPCRCA6-EA",
                                     name: "UPC Part B: RC/TT - AP, 6 lbs")
                
                case .fc:
                
                self.partB = Product(id: "EX-KUPCRCF6-EA",
                                     name: "UPC Part B: RC/TT - FC, 6 lbs")
            ...
            self.partA = Product(id: "EX-KUPCARC-EA",
                                 name: "UPC Part A: RC/TT, 6 lbs")
            self.partC = Product(id: "EX-KUPCTTC4-EA",
                                 name: "UPC Part C: TT, 6 lbs")
            ...
            self.partA = Product(id: "EX-KUPCASL8-EA",
                                 name: "UPC Part A: SL/MF, 8 lbs")
            self.partC = Product(id: "EX-KUPCSLC2-EA",
                                 name: "UPC Part C: SL, 25 lbs")
            
            switch self.speed {
                
                case .ez:
                
                self.partB = Product(id: "EX-KUPCSLZ8-EA",
                                     name: "UPC Part B: SL/MF - EZ, 8 lbs")
                
                case .ap:
                
                self.partB = Product(id: "EX-KUPCSLB8-EA",
                                     name: "UPC Part B: SL/MF - AP, 8 lbs")
                
                case .fc:
                
                self.partB = Product(id: "EX-KUPCSLF8-EA",
                                     name: "UPC Part B: SL/MF - FC, 8 lbs")
            ...
            self.partA = Product(id: "EX-KUPCASL8-EA",
                                 name: "UPC Part A: SL/MF, 8 lbs")
            self.partC = Product(id: "EX-KUPCMFC-EA",
                                 name: "UPC Part C: MF, 40 lbs")
